#ifndef UE4SS_SDK_BP_leakrain_and_splash_Light_HPP
#define UE4SS_SDK_BP_leakrain_and_splash_Light_HPP

class ABP_leakrain_and_splash_Light_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_leakrain_and_splash_Light(int32 EntryPoint);
}; // Size: 0x268
