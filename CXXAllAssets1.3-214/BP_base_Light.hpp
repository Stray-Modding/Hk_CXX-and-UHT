#ifndef UE4SS_SDK_BP_base_Light_HPP
#define UE4SS_SDK_BP_base_Light_HPP
...
class ABP_base_Light_C : public AActor
{
    ...
    bool Light on/off;                                                                // 0x029C (size: 0x1)
    ...
    bool MeshDynaMat?;                                                                // 0x02B4 (size: 0x1)

    void UserConstructionScript();
    void ReceiveBeginPlay();
    void ExecuteUbergraph_BP_base_Light(int32 EntryPoint);
}; // Size: 0x2B5
