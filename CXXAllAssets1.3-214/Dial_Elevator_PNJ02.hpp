#ifndef UE4SS_SDK_Dial_Elevator_PNJ02_HPP
#define UE4SS_SDK_Dial_Elevator_PNJ02_HPP

class ADial_Elevator_PNJ02_C : public ABP_DialogBase_C
{
    ...
    void ExecuteUbergraph_Dial_Elevator_PNJ02(int32 EntryPoint);
}; // Size: 0x360
