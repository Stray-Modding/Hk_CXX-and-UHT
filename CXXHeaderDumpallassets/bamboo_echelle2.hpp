#ifndef UE4SS_SDK_bamboo_echelle2_HPP
#define UE4SS_SDK_bamboo_echelle2_HPP

class Abamboo_echelle2_C : public AActor
{
    class UStaticMeshComponent* StaticMesh8;                                          // 0x0228 (size: 0x8)
    class UStaticMeshComponent* StaticMesh7;                                          // 0x0230 (size: 0x8)
    ...
    class UStaticMeshComponent* bamboo_bamboo01;                                      // 0x0270 (size: 0x8)
