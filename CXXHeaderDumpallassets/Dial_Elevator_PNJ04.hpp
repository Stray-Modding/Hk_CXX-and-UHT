#ifndef UE4SS_SDK_Dial_Elevator_PNJ04_HPP
#define UE4SS_SDK_Dial_Elevator_PNJ04_HPP

class ADial_Elevator_PNJ04_C : public ABP_DialogBase_C
{
    ...
    void ExecuteUbergraph_Dial_Elevator_PNJ04(int32 EntryPoint);
}; // Size: 0x360
