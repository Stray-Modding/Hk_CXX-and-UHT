...
class UGraphicsSettingsWidget : public UHKUserWidget
{
    ...
    class UListBoxWidget* ResolutionListBox;                                          // 0x0308 (size: 0x8)
    class UListBoxWidget* FrameRateListBox;                                           // 0x0310 (size: 0x8)
    class UHorizontalBox* GraphicsMemoryBox;                                          // 0x0318 (size: 0x8)
    class UTextBlock* GraphicsMemoryText;                                             // 0x0320 (size: 0x8)
    class UListBoxWidget* ScreenPercentageListBox;                                    // 0x0328 (size: 0x8)
    class UListBoxWidget* EffectsQualityListBox;                                      // 0x0330 (size: 0x8)
    class UListBoxWidget* ShadowQualityListBox;                                       // 0x0338 (size: 0x8)
    class UListBoxWidget* TextureQualityListBox;                                      // 0x0340 (size: 0x8)
    class UListBoxWidget* MeshQualityListBox;                                         // 0x0348 (size: 0x8)
    class UCheckBoxWidget* FullscreenCheckBox;                                        // 0x0350 (size: 0x8)
    ...
    class UHKTextBlock* SwitchTabTextBlock;                                           // 0x0450 (size: 0x8)
    class UHKButton* TabLeftButton;                                                   // 0x0458 (size: 0x8)
    class UHKButton* TabRightButton;                                                  // 0x0460 (size: 0x8)
    TSet<FIntPoint> m_resolutions;                                                    // 0x04E0 (size: 0x50)
    TSet<uint32> m_screenPercentages;                                                 // 0x0530 (size: 0x50)
