#ifndef UE4SS_SDK_BP_leakrain_and_splash_B_HPP
#define UE4SS_SDK_BP_leakrain_and_splash_B_HPP

class ABP_leakrain_and_splash_B_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_leakrain_and_splash_B(int32 EntryPoint);
}; // Size: 0x268
