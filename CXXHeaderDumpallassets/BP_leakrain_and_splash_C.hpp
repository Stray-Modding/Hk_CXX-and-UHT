#ifndef UE4SS_SDK_BP_leakrain_and_splash_C_HPP
#define UE4SS_SDK_BP_leakrain_and_splash_C_HPP

class ABP_leakrain_and_splash_C_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_leakrain_and_splash_C(int32 EntryPoint);
}; // Size: 0x268
