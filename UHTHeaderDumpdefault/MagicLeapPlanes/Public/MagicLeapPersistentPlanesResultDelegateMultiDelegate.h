...
UDELEGATE() DECLARE_DYNAMIC_MULTICAST_DELEGATE_SevenParams(FMagicLeapPersistentPlanesResultDelegateMulti, const bool, bSuccess, const FGuid&, QueryHandle, const EMagicLeapPlaneQueryType, QueryType, const TArray<FMagicLeapPlaneResult>&, NewPlanes, const TArray<FGuid>&, RemovedPlaneIDs, const TArray<FMagicLeapPlaneBoundaries>&, NewPolygons, const TArray<FGuid>&, RemovedPolygonIDs);
