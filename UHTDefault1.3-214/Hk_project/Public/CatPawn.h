...
//CROSS-MODULE INCLUDE V2: -ModuleName=JoyLibraryRuntime -ObjectName=SmootherFloat -FallbackName=SmootherFloat
#include "RailHangingTestResult.h"
//CROSS-MODULE INCLUDE V2: -ModuleName=JoyLibraryRuntime -ObjectName=VectorPIDController -FallbackName=VectorPIDController
#include "GroundMaterialOverrideEntry.h"
#include "ZurgSocket.h"
//CROSS-MODULE INCLUDE V2: -ModuleName=JoyLibraryRuntime -ObjectName=SmootherCurved -FallbackName=SmootherCurved
...
//CROSS-MODULE INCLUDE V2: -ModuleName=JoyLibraryRuntime -ObjectName=SmootherRotation -FallbackName=SmootherRotation
