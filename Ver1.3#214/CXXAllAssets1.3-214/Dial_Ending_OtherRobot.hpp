#ifndef UE4SS_SDK_Dial_Ending_OtherRobot_HPP
#define UE4SS_SDK_Dial_Ending_OtherRobot_HPP

class ADial_Ending_OtherRobot_C : public ABP_DialogBase_C
{
    ...
    void ExecuteUbergraph_Dial_Ending_OtherRobot(int32 EntryPoint);
}; // Size: 0x358
