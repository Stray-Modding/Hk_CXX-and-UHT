#ifndef UE4SS_SDK_Rooftop_Block_550_HPP
#define UE4SS_SDK_Rooftop_Block_550_HPP

class ARooftop_block_550_C : public AActor
{
    class UBoxComponent* Box1;                                                        // 0x0228 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x0230 (size: 0x8)
    class UStaticMeshComponent* Door03;                                               // 0x0238 (size: 0x8)
