#ifndef UE4SS_SDK_BP_Clim05_HPP
#define UE4SS_SDK_BP_Clim05_HPP

class ABP_Clim05_C : public AActor
{
    ...
    class UStaticMeshComponent* Clims_vent05;                                         // 0x0260 (size: 0x8)
    class USceneComponent* Scene;                                                     // 0x0268 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0270 (size: 0x8)
    bool Jumpable;                                                                    // 0x0278 (size: 0x1)
    bool Spikes;                                                                      // 0x0279 (size: 0x1)
    bool Red;                                                                         // 0x027A (size: 0x1)
