#ifndef UE4SS_SDK_LOOT_Plant_red_HPP
#define UE4SS_SDK_LOOT_Plant_red_HPP

class ALOOT_Plant_red_C : public AActor
{
    ...
    void ExecuteUbergraph_LOOT_Plant_red(int32 EntryPoint);
}; // Size: 0x250
