#ifndef UE4SS_SDK_BP_Clim06_HPP
#define UE4SS_SDK_BP_Clim06_HPP

class ABP_Clim06_C : public AActor
{
    ...
    class UStaticMeshComponent* Clim_06_pale;                                         // 0x0260 (size: 0x8)
    class UStaticMeshComponent* Clims_vent06;                                         // 0x0268 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0270 (size: 0x8)
    float Random Pale Speed;                                                          // 0x0278 (size: 0x4)
    bool Jumpable;                                                                    // 0x027C (size: 0x1)
    bool Spikes;                                                                      // 0x027D (size: 0x1)
    bool Red;                                                                         // 0x027E (size: 0x1)

    void UserConstructionScript();
    void ReceiveBeginPlay();
    void ExecuteUbergraph_BP_Clim06(int32 EntryPoint);
}; // Size: 0x27F
